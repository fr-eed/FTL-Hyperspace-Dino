...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ArtillerySystem::constructor", typeid(void (ArtillerySystem::*)(WeaponBlueprint &, int , int , int )), ".41554989f5be0b00000041545589cd534889fb4883ec08e844290100", nullptr, 0, 0, &func);
}

void ArtillerySystem::constructor(WeaponBlueprint &weapBlueprint, int roomId, int shipId, int starting_power)
{
	typedef void (*custom_arg_funcptr_t)(ArtillerySystem *this_arg, WeaponBlueprint &weapBlueprint_arg, int roomId_arg, int shipId_arg, int starting_power_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func49::func;
	return execfunc(this, weapBlueprint, roomId, shipId, starting_power);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BatterySystem::constructor", typeid(void (BatterySystem::*)(int , int , int , int )), "534889fb4883ec10e8f3210100", nullptr, 0, 0, &func);
}

void BatterySystem::constructor(int systemId, int roomId, int shipId, int starting_power)
{
	typedef void (*custom_arg_funcptr_t)(BatterySystem *this_arg, int systemId_arg, int roomId_arg, int shipId_arg, int starting_power_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func67::func;
	return execfunc(this, systemId, roomId, shipId, starting_power);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CloakingSystem::constructor", typeid(void (CloakingSystem::*)(int , int , int , int )), "!534889fb4883ec20e8c31701000f57c0488dbb60020000", nullptr, 0, 0, &func);
}

void CloakingSystem::constructor(int systemId, int roomId, int shipId, int starting_power)
{
	typedef void (*custom_arg_funcptr_t)(CloakingSystem *this_arg, int systemId_arg, int roomId_arg, int shipId_arg, int starting_power_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CloneSystem::constructor", typeid(void (CloneSystem::*)(int , int , int , int )), ".534889fb4883ec20e853110100488d8388020000", nullptr, 0, 0, &func);
}

void CloneSystem::constructor(int systemId, int roomId, int shipId, int starting_power)
{
	typedef void (*custom_arg_funcptr_t)(CloneSystem *this_arg, int systemId_arg, int roomId_arg, int shipId_arg, int starting_power_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("DroneSystem::constructor", typeid(void (DroneSystem::*)(int , int , int , int )), "!4156415541544589c44189c889d189f2be????????55", nullptr, 0, 0, &func);
}

void DroneSystem::constructor(int roomId, int shipId, int starting_power, int slot_count)
{
	typedef void (*custom_arg_funcptr_t)(DroneSystem *this_arg, int roomId_arg, int shipId_arg, int starting_power_arg, int slot_count_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func554::func;
	return execfunc(this, roomId, shipId, starting_power, slot_count);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("HackingSystem::constructor", typeid(void (HackingSystem::*)(int , int , int , int )), "41545589d5534889fb4c8da3480200004883ec20", nullptr, 0, 0, &func);
}

void HackingSystem::constructor(int systemId, int roomId, int shipId, int starting_power)
{
	typedef void (*custom_arg_funcptr_t)(HackingSystem *this_arg, int systemId_arg, int roomId_arg, int shipId_arg, int starting_power_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("MindSystem::constructor", typeid(void (MindSystem::*)(int , int , int , int )), "534889fbe897c30000f30f1005", nullptr, 0, 0, &func);
}

void MindSystem::constructor(int systemId, int roomId, int shipId, int starting_power)
{
	typedef void (*custom_arg_funcptr_t)(MindSystem *this_arg, int systemId_arg, int roomId_arg, int shipId_arg, int starting_power_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Shields::AddDamage", typeid(void (Shields::*)(int )), ".!534889fbe877410000", nullptr, 0, 0, &func);
}

void Shields::AddDamage(int amount)
{
	typedef void (*custom_arg_funcptr_t)(Shields *this_arg, int amount_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Ship::FillRoomSlot", typeid(void (Ship::*)(int , int , bool )), "!.4863c20fb6d1488b4f10488b3cc1e90da1ffff", nullptr, 0, 0, &func);
}

void Ship::FillRoomSlot(int slotId, int roomId, bool intruder)
{
	typedef void (*custom_arg_funcptr_t)(Ship *this_arg, int slotId_arg, int roomId_arg, bool intruder_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipObject::AddEquipment", typeid(void (ShipObject::*)(const std::string &)), ".415741564155415455534889fb4883ec38488d7c2420", nullptr, 0, 0, &func);
}

void ShipObject::AddEquipment(const std::string &blueprintId)
{
	typedef void (*custom_arg_funcptr_t)(ShipObject *this_arg, const std::string &blueprintId_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func1087::func;
	return execfunc(this, blueprintId);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipSystem::SetFloorImage", typeid(void (ShipSystem::*)(const std::string &)), ".4157415641554154554889f5534883ec48", nullptr, 0, 0, &func);
}

void ShipSystem::SetFloorImage(const std::string &name)
{
	typedef void (*custom_arg_funcptr_t)(const std::string &name_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WeaponSystem::constructor", typeid(void (WeaponSystem::*)(int , int , int , int )), "!4156415541544589c44189c889d189f2be0300000055", nullptr, 0, 0, &func);
}

void WeaponSystem::constructor(int roomId, int shipId, int starting_power, int slot_count)
{
	typedef void (*custom_arg_funcptr_t)(WeaponSystem *this_arg, int roomId_arg, int shipId_arg, int starting_power_arg, int slot_count_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WeaponSystem::SetCloakingSystem", typeid(void (WeaponSystem::*)(CloakingSystem &)), ".4889b790020000c3", nullptr, 0, 0, &func);
}

void WeaponSystem::SetCloakingSystem(CloakingSystem &cloaking)
{
	typedef void (*custom_arg_funcptr_t)(WeaponSystem *this_arg, CloakingSystem &cloaking_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func1457::func;
	return execfunc(this, cloaking);
}
