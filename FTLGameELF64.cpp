...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CommandGui::ClearLocation", typeid(void (CommandGui::*)()), ".53??8b8770190000??89fb??8dbf88050000??8b40108bb08c020000", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewDrone::ShipDamage", typeid(bool (CrewDrone::*)(float )), ".0f57c90f2ec877??31c0c30f1f440000f30f5905????????e9????????906690", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewMember::ShipDamage", typeid(bool (CrewMember::*)(float )), ".!e9ab35ffff", nullptr, 0, 0, &func);
}
