...
namespace _func303
{
    static void *func = 0;
	static short argdata[] = {0x1ff};
	static FunctionDefinition funcObj("CommandGui::ClearLocation", typeid(void (CommandGui::*)()), "5383ec188b5c????8b83b41200008b40088b887c010000", argdata, 1, 6, &func);
}
...
namespace _func406
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("CrewDrone::ShipDamage", typeid(bool (CrewDrone::*)(float )), "f30f1044????0f57c90f2ec877??31c0c38db42600000000", argdata, 2, 2, &func);
}

bool CrewDrone::ShipDamage(float amount)
{
	typedef bool __attribute__((cdecl)) (*custom_arg_funcptr_t)(CrewDrone *this_arg, float amount_arg);
...
namespace _func449
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("CrewMember::ShipDamage", typeid(bool (CrewMember::*)(float )), ".!e9db22ffff", argdata, 2, 2, &func);
}

bool CrewMember::ShipDamage(float amount)
{
	typedef bool __attribute__((cdecl)) (*custom_arg_funcptr_t)(CrewMember *this_arg, float amount_arg);
