...
- [`Point*`](#Point) `.dronePosition`
   - **Read-only**
   - The position of the first drone box generated by the drone system
- [`Point*`](#Point) `.weaponPosition`
   - **Read-only**
   - The position of the first weapon box generated by the weapon system
...
- [`DroneControl`](#DroneControl) `droneControl`
- [`Point`](#Point) `.position`
- `int` `.selectedRoom`
...
- [`Point`](#Point) `.lastIconPos`
- [`Point`](#Point) `.location`
- `int` `.xOffset`
- [`Point`](#Point) `.largeIconOffset`
- [`Point`](#Point) `.nameOffset`
- `int` `.nameWidth`
- `bool` `.mouseHover`
- `bool` `.selected`
- `int` `.hotKey`
- [`GL_Color`](./Lua-Graphics-Module#GL_Color) `.iconColor`
- `bool` `.droneVariation`
- `bool` `.bIoned`
...
- `void :DeselectArmament(unsigned int i)`
- `void :SwapArmaments(int a, int b)`

### Fields
- `int` `.systemId`
- [`std::vector<ArmamentBox*>`](#ArmamentBox) `.boxes`
- [`Point`](#Point) `.location`
- `bool` `.bDragging`
