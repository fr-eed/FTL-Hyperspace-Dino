...
namespace _func402
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("CrewDrone::ShipDamage", typeid(bool (CrewDrone::*)(float )), "57660fefc931c08d????0883e4f0ff????5589e55783ec14f30f10??0f2ec877??8b????c98d??f85fc20400", argdata, 2, 1, &func);
}

bool CrewDrone::ShipDamage(float amount)
{
	typedef bool __attribute__((thiscall)) (*custom_arg_funcptr_t)(CrewDrone *this_arg, float amount_arg);
...
namespace _func532
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("CrewMember::ShipDamage", typeid(bool (CrewMember::*)(float )), ".578d????0883e4f0ff????5589e55783ec14f30f10??f30f1104??e8????????8b????83ec04c98d??f85fc204009090", argdata, 2, 1, &func);
}

bool CrewMember::ShipDamage(float amount)
{
	typedef bool __attribute__((thiscall)) (*custom_arg_funcptr_t)(CrewMember *this_arg, float amount_arg);
