...
namespace _func794
{
	static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("ResourceControl::ShipGlow", typeid(bool (ResourceControl::*)()), ".b801000000c3", argdata, 1, 1, &func);
}

bool ResourceControl::ShipGlow()
{
	typedef bool __attribute__((thiscall)) (*custom_arg_funcptr_t)(ResourceControl *this_arg);
